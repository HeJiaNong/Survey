...
@section('body')
    ...
    <div class="x-body">
        ...
        <xblock>
            ...
            <button class="layui-btn" onclick="x_admin_show('添加班级','{{ route('admin_grade_addPage_get') }}',600,400)"><i
        ...
        <table class="layui-table">
            ...
            @foreach($dataset as $data)
                <tr>
                    ...
                    <td>
                    {{-- 返回值不重复 --}}
                    @foreach($data->teacher->unique() as $value)
                        {{ $value->name }}&nbsp;
                    @endforeach
                    </td>
                    ...
                    <td class="td-manage">
                        ...
                        @endif
                        <a title="编辑" onclick="x_admin_show('编辑','{{ route('admin_grade_editPage_get',$data->id) }}',600,400)" href="javascript:;">
                            <i class="layui-icon">&#xe642;</i>
                        </a>
