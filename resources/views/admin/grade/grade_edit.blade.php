    ...
    <form id="addForm" class="layui-form" action="{{ route('admin_grade_editStore_put',$grade->id) }}" method="post">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input value="{{ $grade->name }}" type="text" id="L_username" name="name" required="" lay-verify="nikename"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input value="{{ $grade->count }}" type="text" id="L_username" name="count" required="" lay-verify="nikename"
                       autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
