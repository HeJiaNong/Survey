...
@section('body')
    ...
    <div class="x-nav">
      <span class="layui-breadcrumb">
        <a><cite>{{ $word->name }}</cite></a>
          <a href="{{ route('admin_word_result_scrapResultsPage',$word->id) }}"><cite>作废答卷</cite></a>
      </span>
    ...
    <div class="x-body">
        <xblock>
            ...
            &nbsp;&nbsp;<span><a class="layui-btn layui-btn-primary" href="{{ route('admin_word_result_scrapResultsPage',$word->id) }}">作废答卷</a></span>
        ...
        @if($data->total() >= 1)
            <div  style="width:auto; height:auto; overflow:scroll;margin: 20px">
                <table  align="center" style="width:5000px;"  class="layui-table"  lay-size="sm"  >
            <thead>
            <tr>
            ...
            @foreach($data as $result)
                <tr>
                    ...
                    <td class="td-manage">
                        ...
                        &nbsp;&nbsp;
                        <a title="恢复" onclick="member_del(this,'{{ route('admin_word_result_status_get',$result->id) }}')" href="javascript:;"><i class="iconfont">&#xe6aa;</i></a>
                    </td>
...
@section('footer')
    <script>
        ...
        function member_del(obj,url){
            layer.confirm('确认要恢复此答卷吗？',function(index){
