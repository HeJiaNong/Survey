...
//    {
//
//        $dataset = User::where('status', '!=', -1)->orderBy('id', 'asc')->paginate(20);  //按时间倒序
//        return view('admin.user.user_list', compact('dataset'));
//    }
//
//
//    /*
...
//
    ...
    {
        return view('admin.user.user_password', compact('user'));
    }
//
//
    /*
...
//        if (empty($username)) {
//            //如果用户名为空，则不添加用户名条件
//            $dataset = User::where('status', '<>', -1)->whereBetween('created_at', [$start, $end])->orderBy('created_at', 'desc')->paginate(20);
//        } else {
//            //如果都有值，则添加所有条件
//            $dataset = User::where('status', '<>', -1)->where('name', 'like', '%' . $username . '%')->whereBetween('created_at', [$start, $end])->orderBy('created_at', 'desc')->paginate(20);
//        }
//
//        $start = explode(' ', $start)[0];
//        $end = explode(' ', $end)[0];
//
//        return view('admin.user.user_list',compact('dataset', 'start', 'end', 'username'));
//    }
//
//
//    /*
...
//        return view('admin.user.user_del', compact('users'));
//    }
//
//
//    /*
...
//        $end = explode(' ', $end)[0];
//
//        return view('admin.user.user_del',compact('users', 'start', 'end', 'username'));
//    }
